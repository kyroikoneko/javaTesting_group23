...
java -cp bin;C:\selenium\lib\xstream-1.4.8.jar; C:\selenium\lib\xstream\xpp3_min-1.1.4c.jar;C:\selenium\lib\xstream\xmlpull-1.1.3.1.jar;C:\selenium\selenium-server-standalone-2.45.0.jar -DconfigFile = firefox.properties org.testng.TestNG testng-customsuite.xml